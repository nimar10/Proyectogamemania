...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-warning text-center">{{ __('REGISTRO DEL USUARIO') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control" name="telefono" max="9">
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dni" type="text" class="form-control" name="dni" max="9">
                            </div>
                        </div>
