...
@section('contenido')
    ...
    <div class="container">
        <div class="row" id="detallee">
            <div class="col mb-4">
                <div class="card">
                <img src="{{asset($accesorio->imagen)}}"   class="card-img-top " alt="...">
                    <div class="card-body">
                    ...
                    <a href="{{route('accesorios.index')}}" class="btn btn-block btn-success rounded-pill">Regresar a accesorios</a>
                    </div>
                </div>
            </div>
        </div>
