...
@section('contenido')
    ...
    <div class="container">
        ...
        <div class="card bg-darken-3 bg-center mt-5" style="background-image: url(../img/accesorios/accesorios2.jpg); background-repeat: no-repeat">
                ...
                <form name="crear" method='POST' action="{{ route('accesorios.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-row mt-3">
                        <div class="col">
                            ...
                            <a href="{{ route('accesorios.index') }}" class="btn btn-info">Volver</a>
                        </div>
                    </div>
                </form>
            </div>
